...
import type { MasterColumnDefinition } from "@/components/master/use-master-columns";
...
type TransactionListSettingsMenuProps<K extends string> = {
...
export function TransactionListSettingsMenu<K extends string>({
  orderedColumns,
  columnVisibility,
  onToggleColumn,
  onMoveColumn,
  ...
  className,
  printOrientation,
}: TransactionListSettingsMenuProps<K>) {
